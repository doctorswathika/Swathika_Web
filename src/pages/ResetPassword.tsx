          ...
          <div className="glass rounded-2xl p-8 lg:p-10 space-y-6">
            {success ? (
              <div className="text-center space-y-4">
                ...
                <h1 className="font-serif-display text-2xl font-semibold text-foreground">Password Updated</h1>
                <p className="text-sm text-muted-foreground font-sans-body">Your password has been reset successfully.</p>
                <a
                  href="/admin/login"
              ...
              <div className="text-center space-y-4">
                ...
                <h1 className="font-serif-display text-2xl font-semibold text-foreground">Invalid Link</h1>
                <p className="text-sm text-muted-foreground font-sans-body">This password reset link is invalid or has expired.</p>
                <a href="/admin/login" className="text-sm text-primary font-sans-body hover:underline">← Back to Admin Login</a>
              </div>
            ) : (
              <>
                <div className="text-center space-y-3">
                  ...
                  <h1 className="font-serif-display text-2xl font-semibold text-foreground">Set New Password</h1>
                  <p className="text-sm text-muted-foreground font-sans-body">Enter your new password below.</p>
                </div>
