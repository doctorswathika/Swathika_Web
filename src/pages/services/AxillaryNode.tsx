...
export default function AxillaryNode() {
  return (
    <ServicePageLayout
      ...
      overview={[
        "The axillary lymph nodes, located in the armpit, are the main drainage site for the breast and play a key role in breast cancer staging and treatment planning. Determining whether cancer has spread to these nodes is essential for planning effective treatment.",
      ...
      process={[
        ...
        { step: "Surgical Planning", description: "The type of axillary surgery will be decided based on imaging findings, clinical staging, and patient conditions." },
