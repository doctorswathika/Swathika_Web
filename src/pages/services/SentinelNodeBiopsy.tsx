  ...
  return (
    <ServicePageLayout
      ...
      overview={[
        ...
        "By examining only the sentinel node, we can appropriately stage breast cancer with the aim to avoid full axillary lymph node dissection and it's associated complications such as lymphoedema.",
