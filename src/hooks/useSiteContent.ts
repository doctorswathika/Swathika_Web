...
const SITE_CONTENT: SiteContentMap = {
  ...
  "faq_items": {
    "content": "[{\"q\":\"What types of breast surgery does Dr. Swathika perform?\",\"a\":\"Dr. Swathika offers a comprehensive range of breast procedures including mastectomy, breast conserving & oncoplastic surgery, sentinel node biopsy, axillary node surgery, breast reduction & augmentation, lipomodelling, implant reconstruction, and gynaecomastia correction.\"},{\"q\":\"Can I have breast reconstruction at the same time as mastectomy?\",\"a\":\"Yes, immediate reconstruction is often possible and is one of Dr. Swathika's specialities. This is discussed during your initial consultation based on your clinical situation and cancer treatment plan.\"},{\"q\":\"How long does recovery take after breast surgery?\",\"a\":\"Recovery varies by procedure. Most patients recover within 4–6 weeks. You can typically return to light activities within 2 weeks, but heavy lifting should be avoided for 6 weeks. Dr. Swathika provides personalised recovery guidance for every patient.\"},{\"q\":\"What is oncoplastic surgery?\",\"a\":\"Oncoplastic surgery combines cancer surgery with plastic surgery reshaping techniques. It allows removal of tumours while actively reshaping the breast to maintain a natural, symmetrical appearance — giving the best oncological and cosmetic outcomes together.\"},{\"q\":\"Am I a candidate for breast conserving surgery?\",\"a\":\"Suitability depends on tumour size relative to breast size, tumour location, and whether clear margins can be achieved. Studies show that breast conserving surgery combined with radiation provides survival outcomes equivalent to mastectomy for appropriately selected patients.\"},{\"q\":\"What is the risk of lymphoedema after sentinel node biopsy?\",\"a\":\"The risk of lymphoedema after sentinel node biopsy is approximately 5–7%, much lower than the 20–30% risk associated with full axillary clearance. This minimally invasive technique preserves arm function while providing accurate cancer staging.\"},{\"q\":\"How experienced is Dr. Swathika?\",\"a\":\"Dr. Swathika holds a dedicated MCh in Breast Oncoplastic & Reconstructive Surgery from the UK, is GMC registered, and has performed over 700 breast procedures — making her one of the most qualified oncoplastic surgeons in Chennai.\"},{\"q\":\"How do I book a consultation?\",\"a\":\"You can book a consultation through our website by clicking 'Book a Consultation', or reach out via WhatsApp or phone. Consultations are confidential and include a thorough assessment with a personalised care plan.\"}]",
    "alignment": "left"
  }
};
