 ...
 * Uses SITE_CONTENT as initial fallback, then fetches latest from `site_content` table.
 */
...
const SITE_CONTENT: SiteContentMap = {
  ...
  testimonials_title: {
    content:
      'Trust & <span class="text-gradient-rose italic">Transformation</span>',
    alignment: "left",
  },
  ...
  svc_mastectomy_subtitle: {
    content:
      "A carefully planned surgical procedure to remove all or part of the breast performed with precision, compassion and a focus on your recovery and confidence.",
    alignment: "left",
  },
  svc_mastectomy_overview_1: {
    content:
      "Mastectomy is the surgical removal of the entire breast and is recommended when breast conserving surgery is not suitable. It may involve removal of one breast (unilateral) or both breasts (bilateral), depending on the clinical and personal circumstances.",
    alignment: "left",
  },
  consultation_title: {
    content:
  ...
  svc_mastectomy_overview_2: {
    content:
      "Dr. Swathika Rajendran performs mastectomy as part of a comprehensive oncological plan, ensuring clear surgical margins and thorough staging. The procedure is closely coordinated with oncology, radiology and pathology teams.",
    alignment: "left",
  },
  svc_mastectomy_overview_3: {
    content:
      "Immediate or delayed breast reconstruction can be planned at the time of mastectomy, allowing patients to make an informed decision that suits their priorities and recovery journey.",
    alignment: "left",
  },
  svc_bco_overview_1: {
    content:
  ...
  svc_bco_overview_2: {
    content:
      "Oncoplastic surgery takes this a step further combining cancer surgery with plastic surgery principles to actively reshape the breast during the operation, allowing removal of larger tumours while maintaining the breast appearance.",
    alignment: "left",
  },
  svc_bco_overview_3: {
    content:
      "Dr. Swathika Rajendran holds a specialised MCh in Breast Oncoplastic & Reconstructive Surgery from the UK one of the few surgeons in India with this level of dedicated training.",
    alignment: "left",
  },
  svc_sentinel_subtitle: {
    content:
      "A minimally invasive procedure to accurately stage breast cancer by identifying and examining the first lymph nodes in the drainage pathway guiding the most precise treatment plan.",
    alignment: "left",
  },
  svc_sentinel_overview_1: {
    content:
      "Sentinel lymph node biopsy (SLNB) is the gold standard technique to determine whether breast cancer has spread to the lymphatic system. It identifies the sentinel node the first node to receive drainage from the tumour.",
    alignment: "left",
  },
  ...
  svc_axillary_subtitle: {
    content:
      "Precise assessment and management of axillary lymph nodes a critical step in staging and treating breast cancer with expert surgical care.",
    alignment: "left",
  },
  svc_axillary_overview_1: {
    content:
      "The axillary lymph nodes, located in the armpit, are the primary drainage site for the breast and play a central role in breast cancer staging.",
    alignment: "left",
  },
  svc_axillary_overview_2: {
    content:
      "Dr. Swathika Rajendran performs axillary node surgery as part of a comprehensive breast cancer treatment plan, including sentinel lymph node biopsy or axillary lymph node dissection when indicated.",
    alignment: "left",
  },
  svc_axillary_overview_3: {
    content:
      "As a UK trained oncoplastic surgeon, Dr. Swathika brings an evidence-based, patient centred approach minimising complications such as lymphoedema while ensuring thorough oncological clearance.",
    alignment: "left",
  },
  svc_reduction_subtitle: {
    content:
      "Aesthetic enhancement of breast for comfort, symmetry and confidence with outcomes that complement your natural form.",
    alignment: "left",
  },
  svc_reduction_overview_1: {
    content:
      "Breast reduction surgery (reduction mammoplasty) removes excess breast tissue, skin and fat to achieve a breast size in proportion with your body, relieving physical discomfort and improving posture.",
    alignment: "left",
  },
  svc_reduction_overview_2: {
    content:
      "Breast augmentation enhances the size and shape of the breast using implants or fat transfer, offering a natural improvement tailored to each patient's anatomy and personal goals.",
    alignment: "left",
  },
  ...
  svc_lipo_subtitle: {
    content:
      "Natural breast enhancement and reconstruction using your own fat a versatile, minimally invasive technique with long lasting results.",
    alignment: "left",
  },
  svc_lipo_overview_1: {
    content:
      "Lipomodelling (fat grafting) involves harvesting fat from one area of the body and carefully injecting it into the breast to improve shape, volume, or symmetry.",
    alignment: "left",
  },
  svc_lipo_overview_2: {
    content:
      "The procedure is used both in cosmetic breast surgery and as part of breast reconstruction after cancer treatment, offering a natural alternative to implants with minimal scarring.",
    alignment: "left",
  },
  svc_lipo_overview_3: {
    content:
      "Dr. Swathika uses lipomodelling as a standalone procedure and in combination with other reconstructive techniques to achieve the best possible aesthetic outcome.",
    alignment: "left",
  },
  svc_implant_subtitle: {
    content:
      "Restoring the natural breast form after mastectomy using advanced implant based techniques precision surgery for a renewed sense of self.",
    alignment: "left",
  },
  svc_implant_overview_1: {
    content:
      "Implant based breast reconstruction uses a tissue expander or a definitive implant to restore the breast mound following mastectomy. It can be performed immediately (at the time of mastectomy) or in a delayed setting.",
    alignment: "left",
  },
  svc_implant_overview_2: {
    content:
      "Modern implant techniques, including the use of acellular dermal matrix (ADM), allow for superior implant coverage and a more natural result with reduced complication rates.",
    alignment: "left",
  },
  svc_implant_overview_3: {
    content:
      "Dr. Swathika tailors every reconstruction to the patient's body type, treatment plan and personal preferences, ensuring both oncological safety and aesthetic satisfaction.",
    alignment: "left",
  },
  svc_gynae_subtitle: {
    content:
      "Effective and precise correction of male breast enlargement restoring a natural masculine chest contour with minimal downtime.",
    alignment: "left",
  },
  svc_gynae_overview_1: {
    content:
      "Gynaecomastia is the benign enlargement of male breast tissue, affecting men of all ages. It can cause physical discomfort and significant psychological impact.",
    alignment: "left",
  },
  svc_gynae_overview_2: {
    content:
      "Surgical correction involves removal of the excess glandular tissue and sometimes fat and skin, through carefully placed incisions that minimise visible scarring.",
    alignment: "left",
  },
  svc_gynae_overview_3: {
    content:
      "Dr. Swathika's surgical expertise ensures a natural, flat chest contour with a smooth recovery and minimal risk of recurrence.",
    alignment: "left",
  },
  svc_bco_subtitle: {
    content:
      "Precise tumour removal with expert breast reshaping combining oncological safety with cosmetic excellence for the best possible outcome.",
    alignment: "left",
  },
  svc_mastectomy_benefits: {
    content:
      '["Complete removal of cancerous tissue for improved survival","Reduced risk of cancer recurrence","Option for immediate reconstruction in suitable cases","Skin sparing and nipple sparing techniques when appropriate","Performed by a UK trained oncoplastic specialist","Personalised surgical plan for every patient"]',
    alignment: "left",
  },
  svc_mastectomy_process: {
    content:
      '[{"step":"Initial Consultation","description":"A thorough assessment including clinical examination, review of imaging and biopsy results and a detailed discussion about surgical options tailored to your specific diagnosis."},{"step":"Pre operative Planning","description":"Dr. Swathika works with the multidisciplinary team to finalise the surgical plan, including decisions about the extent of surgery, sentinel node biopsy and potential immediate reconstruction."},{"step":"The Procedure","description":"The surgery is performed under general anaesthesia. Depending on the type of mastectomy, the procedure typically takes 1–3 hours. Drains may be placed to prevent fluid collection."},{"step":"Recovery & Follow up","description":"Hospital stay is usually 1–3 days. You will receive detailed aftercare instructions, wound care guidance and scheduled follow up appointments to monitor healing and discuss further treatment if needed."}]',
    alignment: "left",
  },
  svc_mastectomy_faqs: {
    content:
      '[{"q":"How long does recovery take after a mastectomy?","a":"Most patients recover within 4–6 weeks. You can typically return to light activities within 2 weeks, but heavy lifting should be avoided for 6 weeks. Dr. Swathika provides personalised recovery guidance."},{"q":"Can I have breast reconstruction at the same time?","a":"Yes, immediate reconstruction is often possible and is one of Dr. Swathika\'s specialities. This is discussed during your initial consultation based on your clinical situation."},{"q":"Will I need chemotherapy or radiation after surgery?","a":"This depends on the pathology results and is decided by the multidisciplinary team. Dr. Swathika coordinates closely with oncologists to ensure seamless care."},{"q":"What type of mastectomy will I need?","a":"This is determined by the size, location and type of cancer, along with your personal preferences. Options include simple mastectomy, skin sparing and nipple sparing mastectomy."}]',
    alignment: "left",
  },
  svc_bco_benefits: {
    content:
      '["Aim to Preserve the natural breast with minimal scarring","Equivalent survival outcomes to mastectomy when combined with radiation","Superior cosmetic results compared to standard breast surgery","Allows removal of larger tumours while conserving the breast","Shorter recovery time compared to mastectomy","World-class oncoplastic technique by a UK trained specialist"]',
    alignment: "left",
  },
  svc_bco_process: {
    content:
      '[{"step":"Diagnostic Assessment","description":"Comprehensive evaluation of tumour size, location and breast size to determine appropriate breast conserving surgery."},{"step":"Technique Selection","description":"Dr. Swathika plans the most appropriate oncoplastic approach ranging from simple tissue rearrangement to complex reshaping."},{"step":"The Surgery","description":"Performed under general anaesthesia, typically taking 1–3 hours. The tumour is removed with a surrounding margin of healthy tissue and the breast is actively reshaped."},{"step":"Post operative Care","description":"Most patients go home the same day or the next day. Radiation therapy is typically recommended afterwards."}]',
    alignment: "left",
  },
  svc_bco_faqs: {
    content:
  ...
  svc_sentinel_benefits: {
    content:
      '["Accurate cancer staging with minimal invasiveness","Significantly lower risk of lymphoedema compared to full axillary clearance","Faster recovery and less post operative discomfort","Preserves arm function and mobility"]',
    alignment: "left",
  },
  svc_implant_benefits: {
    content:
      '["Restores breast shape and body symmetry after mastectomy","Can be performed in a single session.","Wide range of implant options for personalised results","Helps avoid donor site related complications compared to autologous (flap) reconstruction.","Improved psychological well-being and body confidence"]',
    alignment: "left",
  },
  svc_sentinel_process: {
    content:
      '[{"step":"Pre operative Mapping","description":"A small amount of radioactive tracer and/or blue dye is injected near the tumour to identify the sentinel lymph node(s)."},{"step":"Identification & Removal","description":"During surgery, Dr. Swathika uses a specialised technique to locate the sentinel node(s), which are then carefully removed through a small incision."},{"step":"Pathological Analysis","description":"The removed nodes are sent for detailed pathological examination to check for the presence of cancer cells."},{"step":"Follow up","description":"Based on the sentinel node biopsy reports, the required further treatment options are discussed."}]',
    alignment: "left",
  },
  svc_sentinel_faqs: {
    content:
      '[{"q":"Is sentinel node biopsy painful?","a":"The procedure is performed under general anaesthesia as part of your breast surgery, so you won\'t feel any pain during the procedure."},{"q":"What is the risk of lymphoedema with SNB?","a":"The risk is approximately 5–7%, much lower than the 20–30% risk associated with full axillary clearance."},{"q":"What happens if cancer is found in the sentinel node?","a":"Further treatment options, which may include additional surgery, radiation, or systemic therapy, are discussed by the multidisciplinary team."},{"q":"Will I have a visible scar?","a":"The incision is small (2–3cm) and placed in the armpit crease, making it barely visible once healed."}]',
    alignment: "left",
  },
  svc_axillary_benefits: {
    content:
      '["Accurate cancer staging to guide the overall treatment plan","Minimally invasive options with sentinel node technique where appropriate","Reduced risk of lymphoedema with careful surgical technique","Combined with breast surgery in a single operation when possible","Evidence-based approach aligned with international guidelines","Expert aftercare and lymphoedema prevention advice"]',
    alignment: "left",
  },
  svc_axillary_process: {
    content:
      '[{"step":"Pre operative Assessment","description":"Ultrasound and biopsy of suspicious axillary nodes are performed to evaluate the extent of nodal involvement before surgery."},{"step":"Surgical Planning","description":"Dr. Swathika determines the optimal axillary surgical approach based on imaging findings, clinical staging and the planned breast operation."},{"step":"The Surgery","description":"Axillary node surgery is performed under general anaesthesia, typically alongside the breast procedure."},{"step":"Post operative Care & Monitoring","description":"Recovery is closely monitored. Patients receive guidance on arm exercises, lymphoedema prevention and wound care."}]',
    alignment: "left",
  },
  svc_axillary_faqs: {
    content:
